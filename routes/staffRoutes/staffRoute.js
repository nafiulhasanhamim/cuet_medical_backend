...
staffrouter.post("/add-medicine-info", detectUserRole, addMedicineInfo);
staffrouter.get("/get-all-medicines-info", detectUserRole, getAllMedicinesInfo);
staffrouter.put("/edit-medicine-info/:medicine_id", detectUserRole, editMedicineInfo);
staffrouter.post(
